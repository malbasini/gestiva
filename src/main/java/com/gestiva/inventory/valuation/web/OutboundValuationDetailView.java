...
public class OutboundValuationDetailView {
    ...
    private List<InventoryConsumptionLineView> consumptions = new ArrayList<>();
    ...
    public List<InventoryConsumptionLineView> getConsumptions() {
        return consumptions;
    }

    public void setConsumptions(List<InventoryConsumptionLineView> consumptions) {
