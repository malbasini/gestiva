...
public class PaymentDueDetailView {
    ...
    private boolean canRegisterMovement;
    private String registerButtonLabel;
    private List<PaymentDueTransactionView> transactions = new ArrayList<>();
    ...
    public boolean isCanRegisterMovement() {
        return canRegisterMovement;
    }

    public void setCanRegisterMovement(boolean canRegisterMovement) {
        this.canRegisterMovement = canRegisterMovement;
    }
    ...
    public void setRegisterButtonLabel(String registerButtonLabel) {
        this.registerButtonLabel = registerButtonLabel;
    }

    public List<PaymentDueTransactionView> getTransactions() {
        return transactions;
    }

    public void setTransactions(List<PaymentDueTransactionView> transactions) {
