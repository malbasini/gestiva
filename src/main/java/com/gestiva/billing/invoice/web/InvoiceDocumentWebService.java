...
public class InvoiceDocumentWebService {

    private final InvoiceRepository invoiceRepository;
    private final InvoiceLineRepository invoiceLineRepository;
    private final CustomerRepository customerRepository;

    public InvoiceDocumentWebService(InvoiceRepository invoiceRepository,
    ...
    public InvoiceDocumentView getDocument(Long tenantId, Long invoiceId) {
        ...
        InvoiceDocumentView view = new InvoiceDocumentView();
        ...
        view.setLines(lines.stream().map(line -> {
            InvoiceDocumentLineView l = new InvoiceDocumentLineView();
